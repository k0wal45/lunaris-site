...
const PersonSub = () => {
  return (
    <div className='flex flex-col justify-center items-center lg:items-start gap-4 max-w-xl'>
      ...
      <p className="text-lg text-justify">Czy marzysz o posiadaniu własnej strony internetowej? Z nami to staje się prostsze niż sobie wyobrażasz! Lunaris Web to jednoosobowy zespół, który specjalizuje się w kompleksowej tworzeniu stron internetowych, logotypów i innych materiałów reklamowych. Daj mi szansę spełnić Twoje marzenia online!</p>
