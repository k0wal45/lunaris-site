...
function Footer() {
  ...
  return (
    ...
    <>
      <section class="flex flex-col lg:flex-row jusitify-center items-start lg:items-center gap-4 lg:justify-around p-10 bg-base-100 text-base-content shadow-inner z-70">
        <div>
          ...
          <p>Lunaris Web<br/>Tworzymy strony internetowe od 2022</p>
        </div> 
        <Newsletter />
      </section>
